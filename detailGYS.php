...
if (isset($_GET['id'])) {
    ...
    $stmtPrdD = $conn->prepare("SELECT * FROM tbl_gys WHERE id=:id");
    //bindParam str , int
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <h6>รายละเอียดของโพสต์</h6>
                    <p><?= $row['gys_desc']; ?></p>
                    <h6>ติดต่อ</h6>
                    <p><?= $row['t_id']; ?></p>
                    <a class="btn btn-success rounded-pill py-3 px-5 me-3" href="booking.php">ติดต่อเจ้าหน้าที่</a>
