                ...
                <div class="mb-5">
                    ...
                    ?>
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="h5 bg-light rounded py-2 px-3 mb-2" href="showarticle.php?typeid=<?= $row['type_id']; ?>"><i class="fa fa-angle-right me-2"></i><?= $row['type_name']; ?></a>
